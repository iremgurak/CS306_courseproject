...
if (isset($_POST["id"]) && !empty($_POST["id"]) && isset($_POST["starttime"]) && !empty($_POST["starttime"])) {
    ...
    if (
        ...
        $stmt_detailed_stmt = mysqli_prepare($link, $sql_detailed);
        if ($stmt_detailed_stmt) {
            
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt_detailed_stmt, "sssss", $param_date, $param_start, $param_end, $param_capacity, $param_location);
        ...
        // Attempt to execute the prepared statement
        if (mysqli_stmt_execute($stmt_detailed_stmt)) {
        ...
        mysqli_stmt_close($stmt_detailed_stmt);
                    ...
                    <div class="row">
                        <div class="col-md-12" style="color:white; margin-top:0px ; margin-bottom:50px;">
                            ...
                            <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                                ...
                                <a href="company_page.php" class="btn btn-default">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
