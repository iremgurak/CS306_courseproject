...
if (isset($_POST["sub"])) {
    ...
    if (
        ...
        $sql_update_user = "UPDATE CreditCardTable SET  creditcard_num='$card_num', creditcard_fullname='$card_owner', creditcard_type='$card_type', creditcard_enddate='$card_end_date', creditcard_cvv=$card_cvv WHERE user_id=$userid AND creditcard_num='$oldnum'";
    ...
    // Check existence of id parameter before processing further
        ...
        $sql_get_card = "SELECT * FROM CreditCardTable C WHERE C.user_id = $userid AND creditcard_num='$oldnum'";
        $result_get_card = mysqli_query($link, $sql_get_card);
        // Bind variables to the prepared statement as parameters
            
        /* Fetch result row as an associative array. Since the result set contains only one row, we don't need to use while loop */
        $row_get_card = mysqli_fetch_assoc($result_get_card);

        // Retrieve individual field value
        $card_num = $row_get_card["creditcard_num"];
        $card_owner = $row_get_card["creditcard_fullname"];
        $card_type = $row_get_card["creditcard_type"];
        $card_end_date = $row_get_card["creditcard_enddate"];
        $card_cvv = $row_get_card["creditcard_cvv"];
}
?>
<!DOCTYPE html>
<html lang="tr">
